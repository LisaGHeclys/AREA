...
import Tutorial2Svg from '../../components/svg/Tutorial2Svg';
  ...
  return (
    <View
      ...
      <View style={Styles.header}>
        <ButtonBack path={'Tutorial1'} />
        <SkipButton />
      </View>
      <View style={Styles.containerSvg}>
        <Tutorial2Svg />
      </View>
      <Title title="Automate the process between your various services" />
      <View style={Styles.text}>
        <Text
          ...
          Look how you can link multiple applications.
        </Text>
      </View>
